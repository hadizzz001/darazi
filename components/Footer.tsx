  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        ...
        setServices(data);  // ✅ store the whole array
      } catch (error) {
...
{services.length > 0 ? (
  ...
  <li className="text-gray-400 italic">Loading...</li>
        ...
        <div className="max-w-7xl mx-auto flex justify-center gap-5 text-lg mt-10">
          ...
          <a href="https://wa.me/96170985822"><FaWhatsapp className="text-[#333] cursor-pointer" /></a>
          <a href="https://www.instagram.com/darazi_trading"><FaInstagram className="text-[#333] cursor-pointer" /></a>
          <a href="https://www.facebook.com/share/1FRjAJdgNq/?mibextid=wwXIfr"><FaFacebook className="text-[#333] cursor-pointer" /></a>
         <a href="https://www.tiktok.com/@darazi.trading">
    <FaTiktok className="text-[#333] cursor-pointer" />
  </a>
        </div>

        {/* Bottom */}
        <div className="text-center mt-10 mb-20">
          <p className="text-sm uppercase">Darazi Trading 2025 ALL RIGHTS RESERVED</p>
        </div>
      </div>
