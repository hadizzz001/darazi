    ...
    <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
      <div className="u-align-center u-container-style u-group u-group-1">
        <div className="u-container-layout u-valign-middle">
          ...
          <p className="  myGray" > 
           At Darazi Trading, we specialize in solar and alternative energy solutions designed to meet modern power needs. We provide high and reliable quality solar systems, inverters, batteries, and related energy products. Based in Lebanon, we serve both residential and commercial clients across the whole region. Our goal is to deliver reliable, efficient, and sustainable energy solutions. We carefully select our products to ensure durability and performance. We believe in supporting the transition toward clean and renewable energy. We provide long-term warranties to ensure protection, trust, and peace of mind. Through our work, we aim to build long-term trust with our customers and partners. Choose us, so comfort and simplicity choose you.</p>
